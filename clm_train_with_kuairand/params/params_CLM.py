...
all_para = {'GPU_INDEX': GPU_INDEX, 'DATASET': DATASET, 'MODEL': MODEL, 'CANDIDATE_ITEM_LIST_LENGTH': CANDIDATE_ITEM_LIST_LENGTH, 'LR': LR,
            ...
            'OPTIMIZER': 'Adam', 'DIR': DIR, 'pxtr_weight': pxtr_weight_for_ranking_sim_loss, 'exp_weight': exp_weight,
            'sim_order_weight': sim_order_weight, 'pxtr_reconstruct_weight': pxtr_reconstruct_weight, 'bias_weight': bias_weight,
            'layer_num': layer_num, 'decay': decay, 'if_debias': if_debias, 'primary_weight': primary_weight,
            'multi_object_weight': multi_object_weight, 'pxtr_prompt': pxtr_weight_for_multi_object}
